...
function from2(id,id2,ide,url){
               var mi_aleatorio=parseInt(Math.random()*99999999);//para que no guarde la página en el caché...
               var vinculo=url+"?id="+id+"&id2="+id2+"&rand="+mi_aleatorio;
               //alert(vinculo);
               miPeticion.open("GET",vinculo,true);//ponemos true para que la petición sea asincrónica
               ...
               {
                       document.getElementById(ide).innerHTML="cargando..<img src='ima/loading.gif' title='cargando...' />";
