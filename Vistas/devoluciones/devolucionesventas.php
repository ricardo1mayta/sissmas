...
$('#numdoc').keypress(function(e) {
    if(e.which == 13) {
      var num=$('#numdoc').val();
      var num=$('#numdoc').val();
      var url="../Vistas/devoluciones/detalledocumento.php";
      $.ajax({
        type: 'GET',
        url: url,
        data: {num:num,dc:dc},                        
        success: function(data){
         $('#viscliente').html(data);       
        }
      });
    }
});
...
function productos(){
  ...
  var url="../Vistas/devoluciones/listadevoluciones.php";
   $.ajax({
     type: "GET",
     url: url,
     data: {u:su}, 
...
function guardar(){
    ...
    var url="../Vistas/devoluciones/savedevoluciones.php";
...
function verproductos(){
    var url="../Vistas/devoluciones/productos.php";
      $.ajax({
        type: 'GET',
        url: url,
        data: {num:'1'},                        
            ...
            <div class="col-md-12">
              <div class="col-md-12">
                <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" id="numdoc" name="numdoc" onclick="busca()" placeholder="0000000">                  
                </div>
                <div id="viscliente">
