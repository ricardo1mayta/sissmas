 ...
 $result=$p->get_pedidos($sede);
  while($lista=$result->fetch_array()){                        
     ...
     <tr id="sell<?=$lista[0]?>" >
       ...
       <td onclick="vender(<?=$lista[0]?>,'<?=md5($lista[0])?>','B')"><i class="fa fa-building-o"  data-toggle="tooltip" title="Vender"></i>BOLETA</td>
       <td onclick="vender(<?=$lista[0]?>,'<?=md5($lista[0])?>','P')"><i class="fa fa-building-o"  data-toggle="tooltip" title="Vender"></i>PROFORMA</td>
