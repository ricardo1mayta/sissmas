...
//optionArr.push({"id":4,"name":"test","cantidad":5,"precio":67});
  ...
  for(var i=0; i< optionArr.length; i++) {
    var row='<tr>'
        ...
        +'<td><span>S/. </span><span><input type="text" style="width:90px" onkeyup="edit_p('+i+',this)" value="'+optionArr[i]['precio']+'"></span></td>'
        +'<td ><span>S/. '+((parseFloat(optionArr[i]['cantidad']))*(parseFloat(optionArr[i]['precio']))).toFixed(2)+'</span></td>'
  ...
  var row='<tr>'
        ...
        +'<th colspan="2" class="bg-gray"><span>S/. </span>'+total.toFixed(2)+'</th>'
        +'</tr>';
