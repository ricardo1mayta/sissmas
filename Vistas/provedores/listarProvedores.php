...
function clientes(s){
  var url="../Vistas/provedores/provedores.php";
   $.ajax({
     type: "POST",
     url: url,
...
function actualizar(){
    ...
    var url="../Vistas/provedores/updateprovedores.php";
...
function guardar(){
    ...
    var ruc=$("#ruc1").val();
    var nom=$("#nombre1").val();
    var url="../Vistas/provedores/saveprovedores.php";
if(ruc!="" & nom!=""){
...
function eliminar(i){
      ...
      //var array=optionArr;
    var url="../Vistas/provedores/deleteprovedores.php";
