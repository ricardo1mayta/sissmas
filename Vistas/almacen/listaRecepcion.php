...
function verdetallecompra(p,f,n){
  pedido=p;
...
var s=<?=$usuario['SED_C_CODIGO']?>;
      ...
      var url="../Vistas/almacen/comprassede.php";
...
function(){
  setTimeout(function(){
    var user=$('#usco').val();
      ...
      var url="../Vistas/almacen/despachar.php";
    
        $.ajax({
               type: "GET",
               url: url,
               data: {idven:id, u:user},
               success: function(data)
               {
                     cargarpedidos('F');
                     swal("OK: "+data);
        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Lista de recepcion de Productos</h3>
