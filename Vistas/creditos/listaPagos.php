                ...
                <table   class="table table-bordered table-hover" id="tablajson">
                  ...
                  <tbody>
                    <?php 
                      ...
                      $total=0;
                      $p = new Creditos();
                       $result=$p->get_pagosv($idcre);
                        
                        while($lista=$result->fetch_array()){  
                        $total=$total+ $lista['VV_N_ABONA'];                   
                           ?>
                           <tr id="sell<?=$lista['VV_C_CODIGO']?>" >
                             <td><?php echo $lista['VV_C_CODIGO']; ?></td>                      
                             <td><?php echo "S/. ".$lista['VV_N_ABONA'] ?></td>
                             <td><?php echo $lista['VV_F_FECHA'] ?></td>
                             <td><?php echo $lista['TPG_D_NOMBRE'] ?></td>
                             <td><?php echo $lista['VV_D_OBS'] ?></td>
                             <td><?php if ($lista['PV_I_IMG']!=""){ ?> <a href="" data-toggle="modal" data-target="#imgviewmodal" data-img="<?=$lista['PV_I_IMG']?>"   data-toggle="tooltip" title="IMAGEN">Ver Comprobante de pago</a>
                             <?php } else{
